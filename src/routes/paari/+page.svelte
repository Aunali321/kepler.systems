...
<div class="container">
    ...
    <section class="section">
        ...
        <div class="comparison-grid">
            <div class="comparison-card">
                ...
                <p class="card-subtitle">Pre-processed datasets optimized for TTS with additional metadata columns
                </p>
            </div>
    ...
    <section class="section" id="languages">
        ...
        <h3 style="color: #00ffd5; text-align: center; margin: 3rem 0 2rem 0;">🎙️ TTS Datasets (Audio Generation)
        </h3>
        <div class="language-grid" id="ttsLanguageGrid">
            <!-- TTS Language cards will be populated by JavaScript -->
        </div>

        <h3 style="color: #40e0d0; text-align: center; margin: 4rem 0 2rem 0;">📚 LLM Training Datasets (Text Only)
        </h3>
...
<footer>
    <div class="container">
        ...
        <p style="color: #666; margin-top: 2rem;">&copy; 2025 PAARI Dataset Analysis. Built with ❤️ for AI research.
        </p>
    </div>
</footer>
...
<script>
    ...
    const ttsLanguageStats = {
        ...
        'UR': { tokens: 2603934, hours: 22.60, cost: 54.68, rows: 10654 },
        'TA': { tokens: 2438925, hours: 21.17, cost: 51.22, rows: 10323 },
        'TE': { tokens: 2403379, hours: 20.86, cost: 50.47, rows: 8386 },
        'HI': { tokens: 2315342, hours: 20.10, cost: 48.62, rows: 10687 },
            ...
            new Chart(costCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: Object.keys(languageStats).map(lang =>
                            languageColors[lang.toLowerCase()] + '80'
                        ),
                        borderColor: Object.keys(languageStats).map(lang =>
